...
public class DeliveryFeeCalculationSurge implements DeliveryFeeCalculationStrategy {
    ...
    public Double calculateDeliveryFee(CartEntity cart) {
        ...
        if(distance > 15.00) {
            return distance * DELIVERY_FARE_MULTIPLIER * 1.5 * 0.75;
        }

        return distance * DELIVERY_FARE_MULTIPLIER * 1.5; //surging the price by 1.5
    }
}
