...
public class PartnerMatchingHighestRatedPartner implements PartnerMatchingStrategy {
    ...
    public List<PartnerEntity> findAllMatchingPartner(OrderRequestEntity orderRequest) {
        ...
        return partnerRepository.findTenNearestTopRatedPartner(orderRequest.getRestaurant().getRestaurantLocation());
    }
}
